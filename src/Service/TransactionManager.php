...
class TransactionManager
{
    ...
    public function handleBankTransfer(
        ...
        dump([$transactionTo->getId(), $transactionTo->getBankTransferLinkedTransaction(), $transactionFrom->getId(), $transactionFrom->getBankTransferLinkedTransaction()]);
        exit('TODO: Create transactions on both bank accounts');
    }
}
